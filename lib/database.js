...
UsersAnonymous = bookshelf.Model.extend({
  tableName: 'users_anonymous',
  idAttribute: 'users_anonymous_id',
  submissions: function () {
    return this.hasMany(Submissions, 'submissions_id');
  }
});
...
Submissions = bookshelf.Model.extend({
  ...
  anonymousUser: function () {
    return this.belongsTo(UsersAnonymous, 'users_anonymous_id');
  },
